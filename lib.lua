...
local LibName = tostring(math.random(1, 100))..tostring("KurumiHub")..tostring(math.random(1, 100))

function KLibrary:CloseOpen()
...
function KLibrary:Destroy()
	game.CoreGui[LibName]:Destroy()
end

function KLibrary:Create()
	...
	local Kurumi = Instance.new("TextLabel")
	local Hub = Instance.new("TextLabel")


	KLib.Name = tostring(LibName)
	KLib.Parent = game.CoreGui
	...
	Kurumi.Name = "Kurumi"
	Kurumi.Parent = Library
	Kurumi.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	...
	Kurumi.TextSize = 20.000
	Kurumi.TextWrapped = true
	Kurumi.TextXAlignment = Enum.TextXAlignment.Left
	...
	Hub.Position = UDim2.new(0, 86 , 0.0205479451, 0)
